...
-- מחיקת משתמש מאוחדת: יעד בכמה ארגונים → הסרה מהארגון הזה; יעד בארגון יחיד →
-- מחיקת חשבון מלאה. כל בדיקות ההרשאה מתבצעות כאן (מקור אמת יחיד).
...
-- מחיקת חשבון מלאה מהעמוד הגלובלי (סופר-אדמין בלבד)
